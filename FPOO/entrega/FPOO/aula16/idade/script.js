class Pessoa { 
 ...
 pessoas.push(new Pessoa("Lucas Sinclair", new Date(2005, 12, 10), "M")); 
 pessoas.push(new Pessoa("Jonathan Byers", new Date(1970, 2, 10), "M")); 
 pessoas.push(new Pessoa("Mike Wheeler", new Date(1950, 7, 22), "M")); 
 pessoas.push(new Pessoa("Max Mayfield", new Date(2010, 5, 1), "F")); 
